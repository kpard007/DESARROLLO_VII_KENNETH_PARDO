...
$contador = 1;
echo "Contando del 1 al 15 con do-while:<br>";
do {
    echo "$contador ";
    $contador++;
} while ($contador <= 15);
...
} while ($entrada != "válido" && $intentos < 3);
...
echo "Generando números aleatorios hasta obtener un 7:<br>";
do {
    $random = rand(1, 20);
    echo "$random ";
    if ($random == 7) {
...
echo "<br>Se encontró el 7, fin del bucle.<br>";
?>
