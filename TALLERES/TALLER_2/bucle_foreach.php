...
$frutas = ["pera", "uva", "mandarina", "papaya", "tamarindo"];
...
//ejemplo de array usando for each
$personajes =[
    "mitico" =>"mortis",
    "epico" =>"angelo",
    "legendario" =>"meg",
...
echo "Personajes de brawl stars: <br>";
foreach ($personajes as $calidad => $brawler){
    echo "$calidad: $brawler<br>";
...
$estudiantes = [
    ["nombre" => "Ana", "notas" => [90, 52, 85]],
    ["nombre" => "Luis", "notas" => [90, 80, 68]],
