...
//funcion que saluda y muestra la hora
function saludarConHora($nombre) {
    // Obtener la hora actual
    $horaActual = date('H:i:s');

    // Saludar a la persona con su nombre y la hora actual
    echo "Hola, $nombre! La hora actual es $horaActual.<br>";
}

saludarConHora("Kenneth");
