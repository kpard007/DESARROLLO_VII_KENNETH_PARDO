...
echo "<h3>Inclusión de un archivo nuevo con saludos</h3>";


include_once 'funciones_utiles.php';

echo "<h3>Saludos en diferentes idiomas:</h3>";
echo saludarEnEspañol("Kenneth") . "<br>";
echo saludarEnIngles("Johan") . "<br>";
echo saludarEnJapones("Pardo") . "<br>";

include_once 'funciones_utiles.php';
echo "El doble de 15 es: " . doblar(15) . "<br>";
