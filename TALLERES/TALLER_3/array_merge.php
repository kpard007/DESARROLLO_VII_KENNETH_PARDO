...
$misComidas = ["arroz con pollo", "sopa de pollo", "arroz con tasajo"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["arroz de verduras", "sopa de lentejas", "arroz con mariscos"]; // Reemplaza con las comidas favoritas de tu amigo
