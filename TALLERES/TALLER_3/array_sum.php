...
// gasto total diario
$totalGastoDiario = array_sum($gastoDiario);
echo "Total de gasto diario: $" . number_format($totalGastoDiario, 2) . "</br>";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//arreglo con informacion de aspectos
$skin = [
    ["nombre" => "Aspecto Legendario", "precio" => 50, "cantidad" => 1],
    ["nombre" => "Aspecto Mítico", "precio" => 30, "cantidad" => 2],
    ["nombre" => "Aspecto Épico", "precio" => 20, "cantidad" => 3]
];

$totalCosto = array_sum(array_map(function($skin) {
    return $skin['precio'] * $skin['cantidad'];
}, $skin));
echo "</br>";

echo "El costo total de las skins es: $" . number_format($totalCosto, 2) . "</br>";
