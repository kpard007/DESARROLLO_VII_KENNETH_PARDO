...
//////////////////////////////////////////////////////////////////////////////
$archivo2 = "prueba.txt";
$contenido2 = "Nuevo ejemplo de creacion de archivo, Kenneth pardo.";

if (file_put_contents($archivo2, $contenido2) !== false){
    echo "Se ha creado el archivo con éxito.</br>";
}
else {
    echo "Error al crear el archivo, intente nuevamente.</br>";
}
