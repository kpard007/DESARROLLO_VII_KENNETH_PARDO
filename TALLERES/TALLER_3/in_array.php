...
$coloresPrimarios = ["verde", "celeste", "amarillo"];
...
$diasSemana = ["lunes", "martes", "miércoles", "jueves", "viernes", "sábado", "domingo", "no festivo"];
$diasBuscar = ["lunes", "sábado", "festivo", "no festivo"];
...
$lenguajes = ["PHP", "Java", "Python", "JavaScript", "CSS"];
$buscarLenguaje = "css";
