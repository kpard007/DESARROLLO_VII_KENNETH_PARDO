...
$verduras =["aguacate", "berenjena", "cacahuate"];
$jsonVerduras = json_encode($verduras);
echo "Arreglo de verduras en Json:</br>$jsonVerduras</br>";
...
$jsonPersonaKen = json_encode($personaKen);
echo "</br>Array asociativo propio en JSON:</br>$jsonPersonaKen</br>";
...
$peliculaFavorita = [
    ...
    "director" => "Tarantino",
    "año" => 2019,
    "actores" => ["Brad pitt", "Leonardo di caprio", "Margott robbie"]
];
