...
echo "Redondeado a 6 decimales: " . round($numero, 6) . "</br>";
...
$precios = [15.99, 225.49, 28.95, 45.75];
...
// redondeo de 0.25
echo "</br>Redondeo personalizado (incremento de 0.25):</br>";
foreach ($valores as $valor) {
    echo "Original: $valor, Redondeado: " . redondeoPersonalizado($valor, 0.25) . "</br>";
}

// redondeo con incremento de 1, al entero mas cercano
echo "</br>Redondeo personalizado (incremento de 1):</br>";
foreach ($valores as $valor) {
    echo "Original: $valor, Redondeado: " . redondeoPersonalizado($valor, 1) . "</br>";
}
